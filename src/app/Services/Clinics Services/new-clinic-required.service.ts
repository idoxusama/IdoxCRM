...
export class NewClinicRequiredService {
  baseUrl:string="http://localhost:5002";
  constructor(private _http:HttpClient,private router:Router) { }

  getNewClinicRequired(Data):Observable<any>{

    let FullUrl = this.baseUrl+"/api/Clinic/GetNewClinicRequired?ExpertID="+Data.ExpertID+"&ExpertTypeID="+Data.ExpertTypeID +
