...
export class ClinicExtentionRequiredService {
  baseUrl:string="http://localhost:5002";
  constructor(private _http:HttpClient,private router:Router) { }

  getClinicExtentionRequiredList(Data):Observable<any>{

    let FullUrl = this.baseUrl+"/api/Clinic/GetClinicAnalysisExtention?ExpertID="+Data.ExpertID+"&ExpertTypeID="+Data.ExpertTypeID +
