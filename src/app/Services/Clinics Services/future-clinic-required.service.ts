...
export class FutureClinicRequiredService {
  baseUrl:string="http://localhost:5002";
  constructor(private _http:HttpClient,private router:Router) { }

  getFutureClinicRequired(Data):Observable<any>{

    let FullUrl = this.baseUrl+"/api/Clinic/GetFutureClinicRequired?ExpertID="+Data.ExpertID+"&ExpertTypeID="+Data.ExpertTypeID
    const headerDict = {
