...
} from './Components/Accounts/aging-report-expert-ortho/aging-report-expert-ortho.component';
import {
  AgingReportExpertPsyschComponent,
} from './Components/Accounts/aging-report-expert-psysch/aging-report-expert-psysch.component';
import {
  AgingReportReferrerOrthoComponent,
} from './Components/Accounts/aging-report-referrer-ortho/aging-report-referrer-ortho.component';
import {
  AgingReportReferrerPsyschComponent,
} from './Components/Accounts/aging-report-referrer-psysch/aging-report-referrer-psysch.component';
...
} from './Components/Accounts/financial-breakdown-medco/financial-breakdown-medco.component';
import {
  FinancialBreakdownOrthoComponent,
} from './Components/Accounts/financial-breakdown-ortho/financial-breakdown-ortho.component';
import {
  FinancialBreakdownPsychComponent,
} from './Components/Accounts/financial-breakdown-psych/financial-breakdown-psych.component';
...
} from './Components/Analysis/analysis-dailysummaryreport/analysis-dailysummaryreport.component';
import {
  AnalysisDocumentreportComponent,
} from './Components/Analysis/analysis-documentreport/analysis-documentreport.component';
...
} from './Components/Analysis/analysis-emailtasksreport/analysis-emailtasksreport.component';
...
} from './Components/Analysis/analysis-idoxstatistics/analysis-idoxstatistics.component';
import {
  AnalysisPsycologistReportSentComponent,
} from './Components/Analysis/analysis-psycologist-report-sent/analysis-psycologist-report-sent.component';
...
} from './Components/CBT CMS/cbtcms-newinstructions/cbtcms-newinstructions.component';
import {
  CBTCMSOutstandingappointmentsComponent,
} from './Components/CBT CMS/cbtcms-outstandingappointments/cbtcms-outstandingappointments.component';
import {
  CBTCMSOutstandingconfirmationComponent,
} from './Components/CBT CMS/cbtcms-outstandingconfirmation/cbtcms-outstandingconfirmation.component';
import {
  CBTCMSOutstandingdischargereportComponent,
} from './Components/CBT CMS/cbtcms-outstandingdischargereport/cbtcms-outstandingdischargereport.component';
import {
  CBTCMSOutstandingexaminationsComponent,
} from './Components/CBT CMS/cbtcms-outstandingexaminations/cbtcms-outstandingexaminations.component';
import {
  CBTCMSOutstandinginitialreportComponent,
} from './Components/CBT CMS/cbtcms-outstandinginitialreport/cbtcms-outstandinginitialreport.component';
...
} from './Components/Clinics/clinics-attendedclinics/clinics-attendedclinics.component';
import {
  ClinicsClinicavailabilitystatusComponent,
} from './Components/Clinics/clinics-clinicavailabilitystatus/clinics-clinicavailabilitystatus.component';
import {
  ClinicsClinicextensionrequiredComponent,
} from './Components/Clinics/clinics-clinicextensionrequired/clinics-clinicextensionrequired.component';
import {
  ClinicsClinicfillanalysisComponent,
} from './Components/Clinics/clinics-clinicfillanalysis/clinics-clinicfillanalysis.component';
...
} from './Components/Clinics/clinics-futureclinicrequired/clinics-futureclinicrequired.component';
import {
  ClinicsNewclinicrequiredComponent,
} from './Components/Clinics/clinics-newclinicrequired/clinics-newclinicrequired.component';
import {
  ClinicsOutstandingcliniclistComponent,
} from './Components/Clinics/clinics-outstandingcliniclist/clinics-outstandingcliniclist.component';
...
} from './Components/Diagnostics CMS/diagnostic-cms-clientlog/diagnostic-cms-clientlog.component';
import {
  DiagnosticCMSDnalistComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-dnalist/diagnostic-cms-dnalist.component';
import {
  DiagnosticCMSHoldcasesComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-holdcases/diagnostic-cms-holdcases.component';
import {
  DiagnosticCMSNewinstructionsComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-newinstructions/diagnostic-cms-newinstructions.component';
import {
  DiagnosticCMSOutstandingappointmentsComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-outstandingappointments/diagnostic-cms-outstandingappointments.component';
import {
  DiagnosticCMSOutstandingexaminationsComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-outstandingexaminations/diagnostic-cms-outstandingexaminations.component';
import {
  DiagnosticCMSOutstandingpostComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-outstandingpost/diagnostic-cms-outstandingpost.component';
import {
  DiagnosticCMSOutstandingrecordComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-outstandingrecord/diagnostic-cms-outstandingrecord.component';
import {
  DiagnosticCMSOutstandingreportsComponent,
} from './Components/Diagnostics CMS/diagnostic-cms-outstandingreports/diagnostic-cms-outstandingreports.component';
import {
  DynamicsetupsDocumenttypesComponent,
} from './Components/Dynamic Setups/dynamicsetups-documenttypes/dynamicsetups-documenttypes.component';
import {
  DynamicsetupsEmailtasktypesComponent,
} from './Components/Dynamic Setups/dynamicsetups-emailtasktypes/dynamicsetups-emailtasktypes.component';
import {
  DynamicsetupsEmailtypeComponent,
} from './Components/Dynamic Setups/dynamicsetups-emailtype/dynamicsetups-emailtype.component';
import {
  DynamicsetupsErrortypeComponent,
} from './Components/Dynamic Setups/dynamicsetups-errortype/dynamicsetups-errortype.component';
import {
  DynamicsetupsFeetypesComponent,
} from './Components/Dynamic Setups/dynamicsetups-feetypes/dynamicsetups-feetypes.component';
import {
  DynamicsetupsGeographicalcoverageComponent,
} from './Components/Dynamic Setups/dynamicsetups-geographicalcoverage/dynamicsetups-geographicalcoverage.component';
import {
  DynamicsetupsIncidenttypesComponent,
} from './Components/Dynamic Setups/dynamicsetups-incidenttypes/dynamicsetups-incidenttypes.component';
...
} from './Components/Dynamic Setups/dynamicsetups-occupancytypes/dynamicsetups-occupancytypes.component';
import {
  DynamicsetupsOccupationsComponent,
} from './Components/Dynamic Setups/dynamicsetups-occupations/dynamicsetups-occupations.component';
import {
  DynamicsetupsPhysiopostcodeComponent,
} from './Components/Dynamic Setups/dynamicsetups-physiopostcode/dynamicsetups-physiopostcode.component';
import {
  DynamicsetupsSpecialitiesComponent,
} from './Components/Dynamic Setups/dynamicsetups-specialities/dynamicsetups-specialities.component';
import {
  DynamicsetupsSystemtypeComponent,
} from './Components/Dynamic Setups/dynamicsetups-systemtype/dynamicsetups-systemtype.component';
import {
  DynamicsetupsTaskcategoryComponent,
} from './Components/Dynamic Setups/dynamicsetups-taskcategory/dynamicsetups-taskcategory.component';
...
} from './Components/ENT CMS/entcms-clinicscheduele/entcms-clinicscheduele.component';
...
} from './Components/ENT CMS/entcms-instructionmanager/entcms-instructionmanager.component';
import {
  EntcmsNewinstructionsComponent,
} from './Components/ENT CMS/entcms-newinstructions/entcms-newinstructions.component';
import {
  EntcmsOutstandingamendmentsComponent,
} from './Components/ENT CMS/entcms-outstandingamendments/entcms-outstandingamendments.component';
import {
  EntcmsOutstandingappointmentsComponent,
} from './Components/ENT CMS/entcms-outstandingappointments/entcms-outstandingappointments.component';
import {
  EntcmsOutstandingexaminationsComponent,
} from './Components/ENT CMS/entcms-outstandingexaminations/entcms-outstandingexaminations.component';
import {
  EntcmsOutstandingrecordComponent,
} from './Components/ENT CMS/entcms-outstandingrecord/entcms-outstandingrecord.component';
import {
  EntcmsOutstandingreportsComponent,
} from './Components/ENT CMS/entcms-outstandingreports/entcms-outstandingreports.component';
import {
...
} from './Components/Experts/experts-cbtexpertclinics/experts-cbtexpertclinics.component';
import {
  ExpertsDiagnosticexpertclinicsComponent,
} from './Components/Experts/experts-diagnosticexpertclinics/experts-diagnosticexpertclinics.component';
import {
  ExpertsDiagnosticproviderComponent,
} from './Components/Experts/experts-diagnosticprovider/experts-diagnosticprovider.component';
...
} from './Components/Experts/experts-entexpertclinics/experts-entexpertclinics.component';
import {
  ExpertsExpertsagreementComponent,
} from './Components/Experts/experts-expertsagreement/experts-expertsagreement.component';
...
} from './Components/Experts/experts-medcoexpertclinics/experts-medcoexpertclinics.component';
import {
  ExpertsOrthopaedicexpertComponent,
} from './Components/Experts/experts-orthopaedicexpert/experts-orthopaedicexpert.component';
import {
  ExpertsOrthopaedicexpertclinicsComponent,
} from './Components/Experts/experts-orthopaedicexpertclinics/experts-orthopaedicexpertclinics.component';
import {
  ExpertsOrthopaedicvenueComponent,
} from './Components/Experts/experts-orthopaedicvenue/experts-orthopaedicvenue.component';
...
} from './Components/Experts/experts-psychologistexpert/experts-psychologistexpert.component';
import {
  ExpertsPsychologistexpertclinicsComponent,
} from './Components/Experts/experts-psychologistexpertclinics/experts-psychologistexpertclinics.component';
import {
  ExpertsPsychologistvenueComponent,
} from './Components/Experts/experts-psychologistvenue/experts-psychologistvenue.component';
...
} from './Components/Experts/experts-rehabexpertclinics/experts-rehabexpertclinics.component';
...
} from './Components/Invoices/invoices-expertclinicexpense/invoices-expertclinicexpense.component';
import {
  InvoicesInvoicemanagerComponent,
} from './Components/Invoices/invoices-invoicemanager/invoices-invoicemanager.component';
import {
  InvoicesOutstandinginvoicesComponent,
} from './Components/Invoices/invoices-outstandinginvoices/invoices-outstandinginvoices.component';
import {
  AssignedMedicalSectretaryListComponent,
} from './Components/Medco CMS/assigned-medical-sectretary-list/assigned-medical-sectretary-list.component';
...
} from './Components/Medco CMS/medcocms-clinicmanager/medcocms-clinicmanager.component';
import {
  MedcocmsClinicsschedueleComponent,
} from './Components/Medco CMS/medcocms-clinicsscheduele/medcocms-clinicsscheduele.component';
...
} from './Components/Medco CMS/medcocms-instructionmanager/medcocms-instructionmanager.component';
import {
  MedcocmsMedicalexpertdocumentsComponent,
} from './Components/Medco CMS/medcocms-medicalexpertdocuments/medcocms-medicalexpertdocuments.component';
import {
  MedcocmsOutstandingamendmentsComponent,
} from './Components/Medco CMS/medcocms-outstandingamendments/medcocms-outstandingamendments.component';
import {
  MedcocmsOutstandingappointmentsComponent,
} from './Components/Medco CMS/medcocms-outstandingappointments/medcocms-outstandingappointments.component';
import {
  MedcocmsOutstandingapprovalComponent,
} from './Components/Medco CMS/medcocms-outstandingapproval/medcocms-outstandingapproval.component';
import {
  MedcocmsOutstandingexaminationsComponent,
} from './Components/Medco CMS/medcocms-outstandingexaminations/medcocms-outstandingexaminations.component';
import {
  MedcocmsOutstandinggprecordreviewComponent,
} from './Components/Medco CMS/medcocms-outstandinggprecordreview/medcocms-outstandinggprecordreview.component';
import {
  MedcocmsOutstandingpart35Component,
} from './Components/Medco CMS/medcocms-outstandingpart35/medcocms-outstandingpart35.component';
import {
  MedcocmsOutstandingrecordComponent,
} from './Components/Medco CMS/medcocms-outstandingrecord/medcocms-outstandingrecord.component';
import {
  MedcocmsOutstandingreportsComponent,
} from './Components/Medco CMS/medcocms-outstandingreports/medcocms-outstandingreports.component';
import {
  MedcocmsPreviousclinicsComponent,
} from './Components/Medco CMS/medcocms-previousclinics/medcocms-previousclinics.component';
import {
  OutstandingAppointmentSchedualComponent,
} from './Components/Medco CMS/outstanding-appointment-schedual/outstanding-appointment-schedual.component';
...
} from './Components/Orthopaedic CMS/orthopaedic-clinicmanager/orthopaedic-clinicmanager.component';
import {
  OrthopaedicClinicsschedueleComponent,
} from './Components/Orthopaedic CMS/orthopaedic-clinicsscheduele/orthopaedic-clinicsscheduele.component';
import {
  OrthopaedicCourtscasesComponent,
} from './Components/Orthopaedic CMS/orthopaedic-courtscases/orthopaedic-courtscases.component';
...
} from './Components/Orthopaedic CMS/orthopaedic-holdcases/orthopaedic-holdcases.component';
import {
  OrthopaedicInstructionmanagerComponent,
} from './Components/Orthopaedic CMS/orthopaedic-instructionmanager/orthopaedic-instructionmanager.component';
import {
  OrthopaedicNewinstructionsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-newinstructions/orthopaedic-newinstructions.component';
import {
  OrthopaedicOutstandingamendmentsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingamendments/orthopaedic-outstandingamendments.component';
import {
  OrthopaedicOutstandingappointmentsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingappointments/orthopaedic-outstandingappointments.component';
import {
  OrthopaedicOutstandingconfirmationComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingconfirmation/orthopaedic-outstandingconfirmation.component';
import {
  OrthopaedicOutstandingexaminationsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingexaminations/orthopaedic-outstandingexaminations.component';
import {
  OrthopaedicOutstandingmedsecComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingmedsec/orthopaedic-outstandingmedsec.component';
import {
  OrthopaedicOutstandingorthoComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingortho/orthopaedic-outstandingortho.component';
import {
  OrthopaedicOutstandingproformaComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingproforma/orthopaedic-outstandingproforma.component';
import {
  OrthopaedicOutstandingrecordComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingrecord/orthopaedic-outstandingrecord.component';
import {
  OrthopaedicOutstandingrecordreviewComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingrecordreview/orthopaedic-outstandingrecordreview.component';
import {
  OrthopaedicOutstandingreferrerreportComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingreferrerreport/orthopaedic-outstandingreferrerreport.component';
import {
  OrthopaedicOutstandingreportsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-outstandingreports/orthopaedic-outstandingreports.component';
import {
  OrthopaedicPreviousclinicsComponent,
} from './Components/Orthopaedic CMS/orthopaedic-previousclinics/orthopaedic-previousclinics.component';
import {
  OrthopaedicStatusreportComponent,
} from './Components/Orthopaedic CMS/orthopaedic-statusreport/orthopaedic-statusreport.component';
import {
  PsychologistcmsAwaitingvideoappointmentsComponent,
} from './Components/Phsycologist CMS/psychologistcms-awaitingvideoappointments/psychologistcms-awaitingvideoappointments.component';
import {
  PsychologistcmsAwaitingvideoapprovalComponent,
} from './Components/Phsycologist CMS/psychologistcms-awaitingvideoapproval/psychologistcms-awaitingvideoapproval.component';
import {
  PsychologistcmsClientlogComponent,
} from './Components/Phsycologist CMS/psychologistcms-clientlog/psychologistcms-clientlog.component';
import {
  PsychologistcmsClinicmanagerComponent,
} from './Components/Phsycologist CMS/psychologistcms-clinicmanager/psychologistcms-clinicmanager.component';
import {
  PsychologistcmsClinicschedueleComponent,
} from './Components/Phsycologist CMS/psychologistcms-clinicscheduele/psychologistcms-clinicscheduele.component';
import {
  PsychologistcmsCourtcasesComponent,
} from './Components/Phsycologist CMS/psychologistcms-courtcases/psychologistcms-courtcases.component';
import {
  PsychologistcmsDnalistComponent,
} from './Components/Phsycologist CMS/psychologistcms-dnalist/psychologistcms-dnalist.component';
import {
  PsychologistcmsHoldcasesComponent,
} from './Components/Phsycologist CMS/psychologistcms-holdcases/psychologistcms-holdcases.component';
import {
  PsychologistcmsInstructionmanagerComponent,
} from './Components/Phsycologist CMS/psychologistcms-instructionmanager/psychologistcms-instructionmanager.component';
import {
  PsychologistcmsNewinstructionsComponent,
} from './Components/Phsycologist CMS/psychologistcms-newinstructions/psychologistcms-newinstructions.component';
import {
  PsychologistcmsOutstandingamendmentsComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingamendments/psychologistcms-outstandingamendments.component';
import {
  PsychologistcmsOutstandingappointmentsComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingappointments/psychologistcms-outstandingappointments.component';
import {
  PsychologistcmsOutstandingconfirmationComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingconfirmation/psychologistcms-outstandingconfirmation.component';
import {
  PsychologistcmsOutstandingexaminationsComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingexaminations/psychologistcms-outstandingexaminations.component';
import {
  PsychologistcmsOutstandingmedsecComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingmedsec/psychologistcms-outstandingmedsec.component';
import {
  PsychologistcmsOutstandingproformaComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingproforma/psychologistcms-outstandingproforma.component';
import {
  PsychologistcmsOutstandingpsychComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingpsych/psychologistcms-outstandingpsych.component';
import {
  PsychologistcmsOutstandingrecordComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingrecord/psychologistcms-outstandingrecord.component';
import {
  PsychologistcmsOutstandingrecordreviewComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingrecordreview/psychologistcms-outstandingrecordreview.component';
import {
  PsychologistcmsOutstandingreferrerreportComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingreferrerreport/psychologistcms-outstandingreferrerreport.component';
import {
  PsychologistcmsOutstandingreportsComponent,
} from './Components/Phsycologist CMS/psychologistcms-outstandingreports/psychologistcms-outstandingreports.component';
import {
  PsychologistcmsPrequestionnaireComponent,
} from './Components/Phsycologist CMS/psychologistcms-prequestionnaire/psychologistcms-prequestionnaire.component';
import {
  PsychologistcmsPreviousclinicsComponent,
} from './Components/Phsycologist CMS/psychologistcms-previousclinics/psychologistcms-previousclinics.component';
import {
  PsychologistcmsStatusreportComponent,
} from './Components/Phsycologist CMS/psychologistcms-statusreport/psychologistcms-statusreport.component';
...
} from './Components/Rehab CMS New/rehabcmsnew-clientlog/rehabcmsnew-clientlog.component';
import {
  RehabcmsnewClinicsschedueleComponent,
} from './Components/Rehab CMS New/rehabcmsnew-clinicsscheduele/rehabcmsnew-clinicsscheduele.component';
import {
  RehabcmsnewNewinstructionsComponent,
} from './Components/Rehab CMS New/rehabcmsnew-newinstructions/rehabcmsnew-newinstructions.component';
...
} from './Components/Rehab CMS New/rehabcmsnew-outstandingappointments/rehabcmsnew-outstandingappointments.component';
import {
  RehabcmsnewOutstandingdischargereportComponent,
} from './Components/Rehab CMS New/rehabcmsnew-outstandingdischargereport/rehabcmsnew-outstandingdischargereport.component';
import {
  RehabcmsnewOutstandingexaminationsComponent,
} from './Components/Rehab CMS New/rehabcmsnew-outstandingexaminations/rehabcmsnew-outstandingexaminations.component';
import {
  RehabcmsnewOutstandinginitialreportComponent,
} from './Components/Rehab CMS New/rehabcmsnew-outstandinginitialreport/rehabcmsnew-outstandinginitialreport.component';
import {
  RehabcmsnewSuspendedComponent,
} from './Components/Rehab CMS New/rehabcmsnew-suspended/rehabcmsnew-suspended.component';
import {
  RehabcmsnewUndertreatmentComponent,
} from './Components/Rehab CMS New/rehabcmsnew-undertreatment/rehabcmsnew-undertreatment.component';
import {
  RehabcmsoldClientlogComponent,
} from './Components/Rehab CMS Old/rehabcmsold-clientlog/rehabcmsold-clientlog.component';
import {
  RehabcmsoldNewinstructionsComponent,
} from './Components/Rehab CMS Old/rehabcmsold-newinstructions/rehabcmsold-newinstructions.component';
...
} from './Components/Rehab CMS Old/rehabcmsold-outstandingappointments/rehabcmsold-outstandingappointments.component';
import {
  RehabcmsoldOutstandingdischargereportComponent,
} from './Components/Rehab CMS Old/rehabcmsold-outstandingdischargereport/rehabcmsold-outstandingdischargereport.component';
import {
  RehabcmsoldOutstandingexaminationsComponent,
} from './Components/Rehab CMS Old/rehabcmsold-outstandingexaminations/rehabcmsold-outstandingexaminations.component';
import {
  RehabcmsoldOutstandinginitialreportComponent,
} from './Components/Rehab CMS Old/rehabcmsold-outstandinginitialreport/rehabcmsold-outstandinginitialreport.component';
import {
  RehabcmsoldSuspendedComponent,
} from './Components/Rehab CMS Old/rehabcmsold-suspended/rehabcmsold-suspended.component';
import {
  RehabcmsoldUndertreatmentComponent,
} from './Components/Rehab CMS Old/rehabcmsold-undertreatment/rehabcmsold-undertreatment.component';
import {
  ReportsBlockbookingreportComponent,
} from './Components/Reports/reports-blockbookingreport/reports-blockbookingreport.component';
...
} from './Components/Reports/reports-instructiongraph/reports-instructiongraph.component';
import {
  ReportsInstructionreportComponent,
} from './Components/Reports/reports-instructionreport/reports-instructionreport.component';
import {
  ReportsInstructionupdateComponent,
} from './Components/Reports/reports-instructionupdate/reports-instructionupdate.component';
...
} from './Components/Reports/reports-referrerstatistics/reports-referrerstatistics.component';
...
} from './Components/Settings/settings-expertavailabilitysettings/settings-expertavailabilitysettings.component';
...
} from './Components/Settings/settings-referrerslots/settings-referrerslots.component';
import {
  SettingsSleepingreferrerComponent,
} from './Components/Settings/settings-sleepingreferrer/settings-sleepingreferrer.component';
import {
  SettingsSolicitorofficeComponent,
} from './Components/Settings/settings-solicitoroffice/settings-solicitoroffice.component';
...
} from './Components/Settings/settings-termsandconditions/settings-termsandconditions.component';
import {
  SoftwareerrorsSupportticketComponent,
} from './Components/Software Errors/softwareerrors-supportticket/softwareerrors-supportticket.component';
import {
  ApplicationConfigurationComponent,
} from './Components/Users/application-configuration/application-configuration.component';
import {
...
{
  path: 'MedicalSecretary/record-review',
  component: AppLayoutComponent,
  children: [
    {
